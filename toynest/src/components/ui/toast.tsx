...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitives.Root
    ref={ref}
    className={cn(
      "flex items-center gap-3 rounded-2xl border p-4 shadow-lg transition-all",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn("rounded-lg p-1 hover:bg-black/5 transition-colors ml-auto", className)}
    {...props}
  >
    <X className="h-4 w-4" />
  </ToastPrimitives.Close>
